...
# model setting
from models.cacnn import create_model
is_attention = True

# path settings
model_name = 'CACNN' 
data_folder_name = 'asa_data' # it should be changed as your asa_data path
...
def main():
    ...
    The function processes data for 20 subjects, normalizes it, and performs a 5-fold cross-validation.
    ...
    for i_flod in range(5):
        ...
        early_stopping = EarlyStopping(monitor='loss', min_delta=0.01, patience=8, mode='auto')
